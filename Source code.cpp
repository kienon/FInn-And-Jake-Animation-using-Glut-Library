...
double theta = 0.0;
float  counter = 300.0, finnmovementscene1 = 130.0;
int X = 0;
int Y = 0;
...
void rectangle3(int x, int y, int w, int h) {
	glBegin(GL_POLYGON);
	glVertex2d(x + finnmovementscene1, y - 400);
	glVertex2d(x + w + finnmovementscene1, y - 400);
	glVertex2d(x + w + finnmovementscene1, y + h - 400);
	glVertex2d(x + finnmovementscene1, y + h - 400);
	glEnd();
}
...
void Hunter1()
{
	...
	//blacklininghand
	glColor3ub(0, 0, 0);
	rectangle3(20, 80, 15, 70);
	//blackliningShirt shoulder left
	glColor3ub(0, 0, 0);
	rectangle3(15, 85, 15, 75);
	...
	glVertex2i(finnmovementscene1 + 260 - 220, 55 - 436); //(x+ve-x-ve,y+ve-y-ve)
	glVertex2i(finnmovementscene1 + 260 - 220, 46 - 436);
	glVertex2i(finnmovementscene1 + 242 - 220, 46 - 436);
	glVertex2i(finnmovementscene1 + 250 - 220, 55 - 436);
	glEnd();

	//shoe right
	glBegin(GL_POLYGON);
	glColor3ub(105, 105, 105);
	glVertex2i(finnmovementscene1 + 290 - 220, 55 - 436);
	glVertex2i(finnmovementscene1 + 290 - 220, 46 - 436);
	glVertex2i(finnmovementscene1 + 308 - 220, 46 - 436);
	glVertex2i(finnmovementscene1 + 300 - 220, 55 - 436);
	glEnd();
...
void rotateHand() {
	...
	//glTranslated(-60, 400, 0);
	glTranslated(60 - counter / 6, -400 - counter - 10, 0);
	glRotated(90, 0, 0, 1);
...
void bullet() {
	...
	glutPostRedisplay();
	glPushMatrix();
	glTranslated(-a + 50, -10, 0.0);
	glScaled(0.6, 1, 0);
	glColor3b(120, 10, 10);
	rectangle(-250, -280, 550, 100);
	glColor3b(120, 10, 10);
	rectangle(-270, -320, 550, 200);
	glColor3b(120, 10, 10);
	rectangle(-290, -370, 550, 300);
	glPopMatrix();
	glutPostRedisplay();
}
...
void hunter()
{
	...
	//blacklininghand
	//glColor3ub(0, 0, 0);
	//rectangle(20, 80, 15, 70);
	//blackliningShirt shoulder left
	//glColor3ub(0, 0, 0);
	//rectangle(15, 85, 15, 75);
...
void MovementHunter1() {
	...
	//glTranslated(finnmovementscene1, 100, 0.0);
...
void Scene1() {
	...
	cloudPos(-400 - 700, -30, 0.4, 0.4);
	cloudPos(-480 - 700, 0, 0.7, 0.7);
	cloudPos(-550 - 700, -20, 0.5, 0.5);
	cloudPos(-750 - 700, -30, 0.3, 0.3);
	cloudPos(-830 - 700, 0, 0.7, 0.7);
	cloudPos(-910 - 700, -20, 0.5, 0.5);

	cloudPos(-400 - 700 - 600, -30, 0.4, 0.4);
	cloudPos(-480 - 700 - 600, 0, 0.7, 0.7);
	cloudPos(-550 - 700 - 600, -20, 0.5, 0.5);
	cloudPos(-750 - 700 - 600, -30, 0.3, 0.3);
	cloudPos(-830 - 700 - 600, 0, 0.7, 0.7);
	cloudPos(-910 - 700 - 600, -20, 0.5, 0.5);
